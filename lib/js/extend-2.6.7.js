...
extend.require=	function(module){
		var self=extend;
...
extend.cmp=	function(a, b){
		...
		else if ( (extend.isMap(a) && extend.isMap(b)) )
		{
			var res=0;
			extend.iterate(a, function(va, k){
				var vb=b[k];
				if ( (extend.isDefined(va) && extend.isDefined(vb)) )
				{
